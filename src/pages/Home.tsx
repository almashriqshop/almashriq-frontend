    ...
    <div className="w-full">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative max-w-7xl mx-auto px-4 text-center z-10 space-y-6">
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-4 text-xs sm:text-sm uppercase tracking-[0.25em] text-luxury-gold max-w-xl mx-auto font-light">
            <motion.div
